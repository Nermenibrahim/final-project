    ...
    <div class="container my-5">
        <div class="mx-2">
            <div class="row justify-content-between mb-2 pb-2">
                ...
                <a href="testimonials/create" class="btn btn-link  link-dark fw-semibold col-auto me-3">➕Add new testimonial</a>
            </div>
                ...
                <table class="table table-hover display" id="_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a class="text-decoration-none text-dark" href="{{route('testimonials.destroy', $testimonial['id'])}}"><img src="{{asset('assets/admin/images/trash-can-svgrepo-com.svg')}}"  onclick="confirm('Are you sure you want to delete?')" ></a></td>
